...
mod relation_oracle {
    ...
    const IRREDUCIBLE_EMITTED: Emitted = Emitted {
        ...
        source: Some(concat!(
            ...
            "  // loop back-edges: block 1, block 2\n",
            "  final t1 = mark0();\n",
            "  if (t1 == 0) {\n",
            "    final t2 = mark2();\n",
            "    if (t2 == 0) {\n",
            ...
            "      return t9;\n",
            "    }\n",
            "    // control rejoins block 1: already emitted above\n",
            "  }\n",
            "}",
        )),
    };
    ...
    const DECLINED_FALLBACK_EMITTED: Emitted = Emitted {
        ...
        // arm; the non-dominating cycle stays an explicit rejoin rather than an
        // invented loop; and the second copy of block 1 states its taken edge to the
