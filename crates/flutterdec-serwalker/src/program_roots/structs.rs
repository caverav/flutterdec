struct ObjectStore {
    // Layout for the 3.12 Dart version.
    ...
    await_stub: u32,                                           // CodePtr
    await_with_type_check_stub: u32,                           // CodePtr
    clone_suspend_state_stub: u32,                             // CodePtr
    ffi_async_callback_send_stub: u32,                         // CodePtr
    init_async_stub: u32,                                      // CodePtr
    return_async_stub: u32,                                    // CodePtr
    return_async_not_future_stub: u32,                         // CodePtr
    init_async_star_stub: u32,                                 // CodePtr
    yield_async_star_stub: u32,                                // CodePtr
    return_async_star_stub: u32,                               // CodePtr
    init_sync_star_stub: u32,                                  // CodePtr
    suspend_sync_star_at_start_stub: u32,                      // CodePtr
    suspend_sync_star_at_yield_stub: u32,                      // CodePtr
    dispatch_table_code_entries: u32,                          // ArrayPtr
    instructions_tables: u32,                                  // GrowableObjectArrayPtr
    obfuscation_map: u32,                                      // ArrayPtr
    loading_unit_uris: u32,                                    // ArrayPtr
    ffi_pointer_class: u32,                                    // ClassPtr
