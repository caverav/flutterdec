...
pub fn decide_cluster(clusters: &mut [Box<dyn Cluster>; constants::MAX_CLUSTER_NUM], class_id: ClassId) -> Result<Box<dyn Cluster>, &str>
{
    match class_id {
...
DECLARE_FIXED_LENGTH_CLUSTER!(OneByteString, { 1
    // to-do
});
/*
