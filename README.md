...
- internal selector forms are also recognized when deterministic (for example `_current` -> `dart.core.Iterator.current`, `_equivalentYear` -> `dart.core.DateTime.equivalentYear`)
